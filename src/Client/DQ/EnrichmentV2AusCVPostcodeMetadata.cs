namespace Experian.Api.Client.DQ
{
    ...
    /// <summary>
    /// The returned Enrichment data, based on the Australian Postcode dataset.
    /// </summary>
    [DataContract]
  public class EnrichmentV2AusCVPostcodeMetadata
    {
    /// <summary>
    ...
    public DatasetMetadata AffluenceCodeDescription { get; set; }
    ...
    public DatasetMetadata LifestageCodeDescription { get; set; }
